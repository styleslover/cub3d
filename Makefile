...
#    Updated: 2025/03/18 19:43:09 by damoncad         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = $(GNL) cub3d.c draw.c free_shit.c init.c key_events.c parsing.c player.c rotate_that_booty.c map_checks.c raycasting.c
